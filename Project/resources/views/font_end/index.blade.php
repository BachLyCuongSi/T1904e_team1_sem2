...
<head>
    <title>Vegefoods - Template by Colorlib</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('css/ionicons.min.cs') }}">
...
<body class="goto-here">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="{{ rote('shop') }}">Shop</a>
    ...
    @asset('modules/products/featured_product');
